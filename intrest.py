# You can edit these if you want to use this for something else, it will work for basically whatever you want to get a increasing interest rate lol-
starting_point = 1000
interest_rate = 0.05
# Below is the year count for how many years you wanna calculate. 
interest_rate_after = 5
